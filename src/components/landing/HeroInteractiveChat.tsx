    ...
    ease: [0.16, 1, 0.3, 1]
      ...
      delay: 0.3
        ...
        <div className="bg-background border border-border rounded-2xl p-4 shadow-sm">
          <p className="text-lg md:text-xl font-medium text-foreground leading-relaxed">
            {displayedText}
            {isTyping && <span className="inline-block w-0.5 h-5 ml-1 bg-primary animate-pulse" />}
          </p>
        </div>
      </motion.div>
      ...
      delay: 0.8
        ...
        <div className="bg-background border border-border rounded-2xl p-4 shadow-sm flex items-center justify-between gap-4">
          <p className="text-lg text-muted-foreground/50 italic flex-1">Tell us about your work...</p>
          <a href="/demo" className="inline-flex items-center justify-center gap-1.5 bg-foreground text-background hover:bg-foreground/90 rounded-full px-4 py-2 text-sm font-semibold transition-colors whitespace-nowrap">
            Try Demo
